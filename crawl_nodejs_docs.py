...
# url_filter = URLPatternFilter(patterns=["*docs*", "*architecture*"])
...
async def insert_chunk(chunk: ProcessedChunk):
    ...
    try:
        ...
        result = supabase.table("node_pages").insert(data).execute()
...
async def main():
    start_url = "https://nodejs.org/en/learn"  # Starting point
